...
namespace Whitted
{
	...
	{
	public:
		Sphere(const glm::vec3& center, const float& radius, WhittedMaterial* _material = new WhittedMaterial{})
			: m_center{ center }, m_radius{ radius }, radius_squared{ radius * radius }, material{ _material }
		{
